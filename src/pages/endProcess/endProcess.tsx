        ...
        <>
            ...
            <main className="container_page_endProcess">
                ...
                <div className="container_cards_horizontal">
                    <CardLog icon={tray} title="Bandeja" val="30" show={true}/>
                    <CardLog icon={cycle} title="Tempo Total de Ciclo" val="10" show={true}/>
                    <CardLog icon={time} title="Tempo de Minutos por Bandeja" val="10" show={true}/>
                    <CardLog icon={memory}  title="Tempo por Memória" val="10" show={true}/>
                    <CardLog icon={note} title="Memórias com Nota Abaixo de A" val="10" show={true}/>
                    <CardLog icon={glass} title="Memórias com Erro na Inspeção" val="10" show={true}/>
                    <CardLog icon={camera} title="Número de Erro na Câmera" val="10" show={true}/>
                    <CardLog icon={error} title="Memória com Erro (Index)" val="10" style={styleCard} show={false}/>
                    <CardLog icon={map} title="Posição de Refugo e Tipo de Erro" val="10" style={styleCard} show={false}/>
                </div>
            </main>
        </>
    )
